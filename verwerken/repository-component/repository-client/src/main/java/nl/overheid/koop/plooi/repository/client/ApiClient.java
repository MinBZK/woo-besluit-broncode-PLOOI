...
public class ApiClient {
    ...
    static final String NR = "versieNummer";
    static final String LBL = "label";
    static final String NAME = "bestandsnaam";
    ...
    public ApiClient(@Value("${repository.base.url:}") String base) {
        this(HttpClient.newBuilder().followRedirects(HttpClient.Redirect.NORMAL), base);
    }

    public ApiClient(HttpClient.Builder builder, @Value("${repository.base.url:}") String base) {
        this.builder = builder;
        this.baseUrl = StringUtils.defaultIfBlank(base, "http://localhost:8010");
        this.logger.debug("Created Repository Service client for {}", this.baseUrl);
    }
