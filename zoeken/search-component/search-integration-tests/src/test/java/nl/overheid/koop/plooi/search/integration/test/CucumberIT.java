package nl.overheid.koop.plooi.search.integration.test;
...
@ConfigurationParameters({
        @ConfigurationParameter(key = Constants.GLUE_PROPERTY_NAME, value = "nl.overheid.koop.plooi.search.integration.test.definitions"),
